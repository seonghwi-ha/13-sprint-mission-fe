...
import type { ProductDetail, ProductComment } from "../../../src/types/product";
import type { CursorPaginatedResponse } from "../../../src/types/pagination";
...
export default function ItemDetailPage(): ReactNode {
  useRequireAuth();
  ...
  const {
    ...
    isLoading,
    isError,
  } = useQuery<ProductDetail | null, Error>({
    queryKey: ["product", productId],
    queryFn: () => getProduct(productId),
  });

  const { data: commentsData } = useQuery<CursorPaginatedResponse<ProductComment> | null, Error>({
